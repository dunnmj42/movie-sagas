...
// GET request for all movies, populates MovieList component
router.get("/", (req, res) => {
...
// GET individual movie by ID for Details component, JOIN on junction table and
// genres table to display genres in Details
...
// 2 stage POST for adding new movie and genre with relation
router.post("/", (req, res) => {
